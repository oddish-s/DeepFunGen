...
import { LicenseView } from './views/license.js';
...
function applyMetadata() {
    ...
    if (metadata?.version) {
        ...
        if (versionLabel) {
            versionLabel.textContent = metadata.version;
        }
    }
}
...
async function bootstrap() {
    ...
    State.subscribe('metadata', applyMetadata);
    ...
    const initialView = views[State.get('activeView')] ? State.get('activeView') : 'queue';
